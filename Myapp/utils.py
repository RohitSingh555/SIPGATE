...
# from .models import SipgateUser


# def fetch_token(name, request):
#     token = SipgateUser.objects.get(name=name, user=request.user)
...
#     if refresh_token:
#         item = SipgateUser.objects.get(name=name, refresh_token=refresh_token)
#     elif access_token:
#         item = SipgateUser.objects.get(name=name, access_token=access_token)
#     else:
#         return
